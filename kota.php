			...
			<form class="form-body" >
		        ...
		        <div class="body-wrap">
					...
					<table border="0" align="center" width="100%" style="text-align:left;padding-left:10px;">
						...
						<tr>
							<td>
								<font color="black">Provinsi</font>
							</td>
							<td>
								...
								<?php
									...
									echo "<option value='belum pilih' selected disabled>Nama Daerah / Provinsi</option>";
									 echo "</select>";
								?>
...
<!-- 
						<tr>
							<td width="150px">
								<font color="black">Kode Kota</font>
							</td>
							<td>
								<input type="text" id="idkota" class="form-body-control" placeholder="Kode Kota / Kabupaten" autofocus>
		            		</td>
 ...
 -->						
						...
						<tr>
							<td width="150px">
								<font color="black">Nama Kota</font>
							</td>
							<td>
								<input type="text" id="namakota" class="form-body-control" placeholder="Nama Kota / Kabupaten" autofocus>
								<input type="hidden" id="id_kota" value="">
		            		</td>
					...
					<tr>
						...
						<input class="btn btn-theme btn-block" type="button" id="simpankota" name="simpandkota" onclick="inputkota()" value="Submit">
						</td>
						
						<td width="50%" style="padding-right:10px">
						<input class="btn btn-theme btn-block" id="editKota_btn" onclick="editKota()" type="button" value="Edit"/>
					...
					<td width="80%" align="left"><b>Daftar Kota / Kabupaten</b>
					</td>
					
					<!-- <td align="right" style="padding-right:10px;">Search
					</td >
					<td>
					<input id="search_parameter" width="200px" type="text" class="form-body-control" placeholder="Kota / Kabupaten" autofocus>
		           	
					
					</td>
					<td><a id="cari" name="cari" href="#" onclick="cariKota()"><img height="39" width="39" src="img/web_search.png"></a></td> -->
					</tr>
					</table>
					</td>
					...
					<!-- <table class="table-bordered table-striped table-condensed cf font-black" width="100%" >
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" class="table-bordered table-striped table-condensed cf font-black"  style="display: block; height: 284px; overflow-y: scroll">
											<thead>
											  <tr align="center">
												<th width="136" scope="col"><center>Provinsi</center></th>
												<th width="102" scope="col"><center>ID Kota</center></th>
												<th width="102" scope="col"><center>Nama Kota</center></th>
