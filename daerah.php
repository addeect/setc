...
<title>Admin SETC | Setting Daerah</title>
			...
			<form class="form-body" >
		        ...
		        <div class="body-wrap">
					...
					<table border="0" align="center" width="100%" style="text-align:left;padding-left:10px;">
						...
						<!-- <tr>
							<td width="150px">
								<font color="black">Kode Daerah</font>
							</td>
							<td>
								<input type="text" id="kodedaerah" class="form-body-control" placeholder="Kode Daerah / Provinsi" autofocus>
		            		</td>
						...
						<tr>
							<td>
								<font color="black">Nama Daerah</font>
							</td>
							<td>
								<input type="text" id="namadaerah" class="form-body-control" placeholder="Nama Daerah / Provinsi">
								<input type="hidden" id="id_daerah" value="" />
							</td>						
						</tr>
					...
					<tr>
						...
						<input class="btn btn-theme btn-block" type="button" id="simpandaerah" name="simpandaerah" onclick="inputdaerah()" value="Submit">
		            
						</td>
						
						<td width="50%" style="padding-right:10px">
						<input class="btn btn-theme btn-block" id="editDaerah_btn" onclick="editDaerah()" type="button" value="Edit">
					...
					<td width="80%" align="left"><b>Daftar Daerah / Provinsi</b>
					</td>
					<!-- 
					<td align="right" style="padding-right:10px;">Search
					</td >
					<td>
					<input id="search_parameter" width="200px" type="text" class="form-body-control" placeholder="Daerah / Provinsi" autofocus>
		           	
					</td>
					<td><a id="cari" name="cari" href="#" onclick="cariDaerah()"><img height="39" width="39" src="img/web_search.png"></a></td-->
					</tr>
					</table>
					</td>>
					...
					<!--table class="table-bordered table-striped table-condensed cf font-black" width="100%" >
                                  ...
                                  <tr>
                                      <th>Kode Daerah</th>
                                      <th>Nama Daerah / Provinsi</th>
                                      <th>Action</th>
								  </tr>
                                  </thead>
                                  <tbody>
                                  <tr>
                                      <td>Kode Daerah ABC</td>
                                      <td>Nama Daerah ABC</td>
                                      <td><a href="#">Edit</a></td>
                                  </tr>
								  ...
								  <tr>
                                      ...
                                      <td><a href="#">Edit</a></td>
										  ...
										  <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" class="table-bordered table-striped table-condensed cf font-black"  style="display: block; width: 450px; height: 228px; overflow-y: scroll">
											<thead>
											  <tr align="center">
												<th width="136" scope="col"><!--input type="checkbox" name="allbox" id="allbox" onclick="checkAll()" /--><center>Kode Daerah</center></th>
												<!--th width="136" scope="col">Nama Pengguna</th>
												<th width="136" scope="col">ID Karyawan</th-->
												<th width="102" scope="col"><center>Nama Daerah</center></th>
