...
<title>Manajemen SETC | Laporan Bulanan</title>
	...
	Selamat Datang, <a href="#"><font color="#fff"><?php echo $_SESSION["sess_namauser"] ?></font></a> | Anda login sebagai <a href="#"><font color="#fff"><?php echo $_SESSION["sess_role"] ?></font></a> 
			...
			<form class="form-body" >
		        ...
		        <div class="body-wrap">
							...
							<br>
							<table class="table table-bordered table-striped table-condensed cf font-black" style="display: block; height:640px; width: 100%; overflow: scroll">
                                  <thead class="cf" >
                                  <tr align="center">
