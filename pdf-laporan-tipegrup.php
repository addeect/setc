...
$html = '<table align="center"><tr><td><span style="font-weight:bold">LAPORAN TIPE GRUP TAHUN '.$tahun.'</span></td></tr></table><br/><br/>';
...
<tr style="background-color:#f0f8ff"><td width="100px">GROUP TYPE</td><td>VISITATION</td><td>TRAINING</td><td>MEETING</td><td>JUMLAH</td></tr>';

$query1 = "SELECT (instansi.tipe_instansi) as Tipe_Instansi, sum(kunjungan.id_keperluan=1) AS Visitation, Sum(kunjungan.id_keperluan=2) AS Training, Sum(kunjungan.id_keperluan=3) AS Meeting, count(kunjungan.id_kunjungan) AS Jumlah
...
$pdf->Output('Laporan-Tipe-Grup-'.$tahun.'.pdf', 'I');
