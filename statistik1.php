...
<title>Operator SETC | Setting Kota</title>
					...
					<table border="0" width="100%">
						...
						<tr width="100%" height="100px">
							...
							<!--input type="text" class="form-body-control" placeholder="Nama Daerah / Provinsi" autofocus-->
								...
								<option value="laporanbulanan1.php">Bulanan</option>
								<option value="laporantahunan1.php">Tahunan</option>
								<option value="laporantipegrup1.php">Tipe Instansi</option>
