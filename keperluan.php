...
<title>Admin SETC | Setting Keperluan</title>
			...
			<form class="form-body" >
		        ...
		        <div class="body-wrap">
					...
					<table border="0" align="center" width="100%" style="text-align:left;padding-left:10px;">
						...
						<!-- <tr>
							<td width="150px">
								<font color="black">ID Jenis Keperluan</font>
							</td>
							<td>
								<input type="text" id="idkeperluan" class="form-body-control" placeholder="Kode Jenis Keperluan" autofocus>
		            		</td>
						...
						<tr>
							<td>
								<font color="black">Jenis Keperluan</font>
							</td>
							<td>
								<input type="text" id="jeniskeperluan" class="form-body-control" placeholder="Jenis Keperluan" autofocus>
								<input type="hidden" value="" id="id_keperluan">
							</td>						
						</tr>
					...
					<tr>
						...
						<input class="btn btn-theme btn-block" type="button" id="simpankeperluan" name="simpankeperluan" onclick="inputkeperluan()" value="Submit">
						</td>
						
						<td width="50%" style="padding-right:10px">
						<input class="btn btn-theme btn-block" id="editKeperluan_btn" onclick="editKeperluan()" type="button" value="Edit"/>
					...
					<td width="80%" align="left"><b>Daftar Jenis Keperluan</b>
					</td>
					...
					<!--table class="table-bordered table-striped table-condensed cf font-black" width="100%" >
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" class="table-bordered table-striped table-condensed cf font-black"  style="display: block; width:390px; height: 199px; overflow-y: scroll">
											<thead>
											  <tr align="center">
												<th width="136" scope="col"><!--input type="checkbox" name="allbox" id="allbox" onclick="checkAll()" /--><center>ID Keperluan</center></th>
												<!--th width="136" scope="col">Nama Pengguna</th>
												<th width="136" scope="col">ID Karyawan</th-->
												<th width="102" scope="col"><center>Jenis Keperluan</center></th>
